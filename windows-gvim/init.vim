...
map R :source D:\ProfessionalSoftware\Gvim\Vimconfig\init.vim<CR>
...
"" vim-plug
call plug#begin('D:\ProfessionalSoftware\Gvim\Vimconfig\pluged') 
...
" === python shortcut
" ===
source  D:\ProfessionalSoftware\Gvim\Vimconfig\py-snippets.vim
...
source  D:\ProfessionalSoftware\Gvim\Vimconfig\md-snippets.vim
...
"" ===  vimtweak
"" ===
autocmd GUIEnter * call libcallnr("vimtweak", "SetAlpha", 215)
noremap <LEADER>f :call libcallnr("vimtweak", "EnableMaximize",1)<CR>
